...
PNoz = np.loadtxt('C:/Users/swald/OneDrive - MNSCU/447 MACHINELEARNING/Python_Module6/PNOz.dat')
pl.ion()
...
import random
change = random.sample(change, k=len(change))
...
# Train the network
import mlp
net = mlp.mlp(train,traintargets,5,outtype='linear')
